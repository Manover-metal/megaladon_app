...
extension AuthModelQueryFilter
  ...
  QueryBuilder<AuthModel, AuthModel, QAfterFilterCondition> tokenIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AuthModel, AuthModel, QAfterFilterCondition> tokenIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AuthModel, AuthModel, QAfterFilterCondition> tokenEqualTo(
    String? value, {
  ...
  QueryBuilder<AuthModel, AuthModel, QAfterFilterCondition> tokenGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<AuthModel, AuthModel, QAfterFilterCondition> tokenLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<AuthModel, AuthModel, QAfterFilterCondition> tokenBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<AuthModel, AuthModel, QAfterFilterCondition> tokenStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AuthModel, AuthModel, QAfterFilterCondition> tokenEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AuthModel, AuthModel, QAfterFilterCondition> tokenContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AuthModel, AuthModel, QAfterFilterCondition> tokenMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AuthModel, AuthModel, QAfterFilterCondition> tokenIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'token',
        value: '',
  ...
  QueryBuilder<AuthModel, AuthModel, QAfterFilterCondition> tokenIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'token',
        value: '',
...
extension AuthModelQuerySortThenBy
  ...
  QueryBuilder<AuthModel, AuthModel, QAfterSortBy> thenByToken() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'token', Sort.asc);
    });
  }

  QueryBuilder<AuthModel, AuthModel, QAfterSortBy> thenByTokenDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'token', Sort.desc);
    });
  }
...
extension AuthModelQueryWhereDistinct
  ...
  QueryBuilder<AuthModel, AuthModel, QDistinct> distinctByToken(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
