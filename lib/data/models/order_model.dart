...
class OrderModel extends Equatable {
  ...
  static OrderModel fromJsonMini(data) {
    return OrderModel(
        ...
        priceRecommended: data['price_recommended'] != null ? Parser.toPrice(data['price_recommended']) : null,
        priceMax: data['price_max'] != null ? Parser.toPrice(data['price_max']) : null,
