...
class AdvertCategoryFormModel extends FormzInput<int, AdvertCategoryValidationError> {
  ...
  AdvertCategoryValidationError? validator(int value) {
    if (value == AdvertCategoryModel.nothing.id) return AdvertCategoryValidationError.empty;
    return null;
  }
}
