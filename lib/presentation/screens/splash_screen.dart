...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Widget build(BuildContext context) => BlocListener<AuthBloc, AuthState>(
      ...
      // Делаем это реактивно по AuthLogoutState; context.router здесь корневой
      // (SplashScreen — это InitialRouter). Сбрасываем стек, чтобы не остаться
      // на защищённом экране в роли гостя.
      listenWhen: (prev, curr) => curr is AuthLogoutState,
