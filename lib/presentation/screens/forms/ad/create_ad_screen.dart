          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 30),
                TextFieldApp(controller: _titleController, label: 'Название', icon: Icon(Icons.edit)),
                ...
                DescriptionFieldApp(label: LocaleKeys.Description_of_your_offer.tr(), controller: _descriptionController, icon: Icon(IconPack.description),),
                NumberFieldApp(label: LocaleKeys.Price.tr(), controller: _priceController, icon: Icon(Icons.money_sharp),),
                TextFieldApp(controller: _phoneController, label: 'Дополнительный телефон', icon: Icon(Icons.phone),),
